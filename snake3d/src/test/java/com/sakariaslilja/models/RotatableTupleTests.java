...
public class RotatableTupleTests {
    ...
    public void rotateX() {
        ...
        RotatableTuple expected = new RotatableTuple(new Int(1), new Int(-3), new Int(2));
        tuple.rotateX(true);
    ...
    public void rotateY() {
        RotatableTuple tuple = new RotatableTuple(new Int(1), new Int(2), new Int(3));
        RotatableTuple expected = new RotatableTuple(new Int(3), new Int(2), new Int(-1));
        tuple.rotateY(true);
    ...
    public void rotateZ() {
        RotatableTuple tuple = new RotatableTuple(new Int(1), new Int(2), new Int(3));
        RotatableTuple expected = new RotatableTuple(new Int(-2), new Int(1), new Int(3));
        tuple.rotateZ(true);
